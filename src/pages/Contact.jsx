        ...
        <div className="rounded-2xl border border-zinc-800 bg-zinc-900/50 p-8">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-zinc-400">
                Use the form above or email team@7percent.info directly. We
            ...
            <div>
              ...
              <p className="text-zinc-400">
                For urgent issues, please email with "URGENT" in the subject
            ...
            <div>
              ...
              <p className="text-zinc-400">
                ...
                including what device/browser you're using and the exact steps
            ...
            <div>
              ...
              <p className="text-zinc-400">
                Absolutely! We love hearing feature requests. Send us your ideas
