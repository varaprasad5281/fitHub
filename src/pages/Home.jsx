...
const TrustSignals = lazyWithPreload(
  () => import("@/components/landing/TrustSignals"),
);
const PhilosophySection = lazyWithPreload(
  () => import("@/components/landing/PhilosophySection"),
);
const FeaturesSection = lazyWithPreload(
  () => import("@/components/landing/FeaturesSection"),
);
const HowItWorksSection = lazyWithPreload(
  () => import("@/components/landing/HowItWorksSection"),
);
const PricingSection = lazyWithPreload(
  () => import("@/components/landing/PricingSection"),
);
const SocialProofSection = lazyWithPreload(
  () => import("@/components/landing/SocialProofSection"),
);
const FAQSection = lazyWithPreload(
  () => import("@/components/landing/FAQSection"),
);
const MobileAppSection = lazyWithPreload(
  () => import("@/components/landing/MobileAppSection"),
);
const NewsletterSection = lazyWithPreload(
  () => import("@/components/landing/NewsletterSection"),
);
const FooterSection = lazyWithPreload(
