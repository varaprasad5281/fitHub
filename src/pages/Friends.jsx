      ...
      try {
        ...
        if (authenticated) {
          ...
          if (friendships.length === 0) {
            const shownOnboarding = localStorage.getItem(
              "friend_onboarding_shown",
            );
            if (!shownOnboarding) {
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-zinc-400 mt-1">
            Build your accountability network. Progress is easier with
            commitment.
          </p>
        </div>
                ...
                <div className="space-y-3">
                  {suggested.slice(0, 5).map((suggestion) => (
                    <SuggestedFriendsCard
                      ...
                      onAddFriend={() => {
                        api.functions.invoke("friendRequest", {
                          target_email: suggestion.email,
                        });
                        setSuggested(
                          suggested.filter((s) => s.email !== suggestion.email),
                        );
                      }}
                      isLoading={false}
                    />
                ...
                <div className="flex flex-col items-center justify-center py-12">
                  ...
                  <button
                    onClick={() => {
                      ...
                      const friendsBtn =
                        document.querySelector('[value="friends"]');
                      friendsBtn?.click();
                    }}
