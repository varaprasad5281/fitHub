...
const BADGES = [
  ...
  // ─── LEVEL MILESTONES ─────────────────────────────────────────────────────
  {
    badge_code: 'LEVEL_5',
    name: 'Five Star',
    description: 'Reached Level 5. You\'ve built early momentum — keep pushing.',
    icon: '🌟',
    rarity_level: 'rare',
    category: 'level',
  ...
  },
  {
    badge_code: 'LEVEL_10',
    name: 'Veteran',
    description: 'Reached Level 10. You\'ve proven your commitment to the grind.',
    icon: '🏅',
    rarity_level: 'rare',
    category: 'level',
    requirement_type: 'current_level',
  ...
  },
  {
    badge_code: 'LEVEL_15',
    name: 'Elite',
    description: 'Reached Level 15. You are operating at an elite level of consistency.',
    icon: '⚡',
    rarity_level: 'epic',
    category: 'level',
    requirement_type: 'current_level',
  ...
  },
  {
    badge_code: 'LEVEL_20',
    name: 'Master',
    description: 'Reached Level 20. Mastery isn\'t given — it is earned through repetition.',
    icon: '🔥',
    rarity_level: 'epic',
    category: 'level',
    requirement_type: 'current_level',
  ...
  },
  {
    badge_code: 'LEVEL_25',
    name: 'Grandmaster',
    description: 'Reached Level 25. A true grandmaster of discipline and dedication.',
    icon: '💎',
    rarity_level: 'legendary',
    category: 'level',
    requirement_type: 'current_level',
  ...
  },
  {
    badge_code: 'LEVEL_30',
    name: 'Hall of Fame',
    description: 'Reached Level 30. Hall of Fame status. An all-time great.',
    icon: '👑',
    rarity_level: 'legendary',
    category: 'level',
    requirement_type: 'current_level',
  ...
  {
    badge_code: 'REFERRAL_25',
    name: 'Legend Maker',
    description: 'Referred 25 users who subscribed to 7%. You are a force of nature.',
    icon: '🌟',
    rarity_level: 'legendary',
    category: 'referral',
    requirement_type: 'referrals_count',
