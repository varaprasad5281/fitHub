...
const PRICE_MAP = {
  pro_monthly:
    process.env.STRIPE_PRICE_PRO_MONTHLY || "price_1T0ArsDELQ2VxPfdUDBXE7AG",
  pro_yearly:
    process.env.STRIPE_PRICE_PRO_YEARLY || "price_1T0BKHDELQ2VxPfdoiLuP8Zx",
  elite_monthly:
    process.env.STRIPE_PRICE_ELITE_MONTHLY || "price_1T0C7zDELQ2VxPfdd2wDQ7v9",
  elite_yearly:
    process.env.STRIPE_PRICE_ELITE_YEARLY || "price_1T0C7zDELQ2VxPfdttBUeBuJ",
};
